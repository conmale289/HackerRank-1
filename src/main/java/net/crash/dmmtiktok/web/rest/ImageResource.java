...
import net.crash.dmmtiktok.service.ImageService;
...
/**
 * REST controller for managing {@link net.crash.dmmtiktok.domain.Image}.
 */
@RestController
...
public class ImageResource {
    ...
    public ResponseEntity<ImageDTO> createImage(@Valid @RequestBody ImageDTO imageDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/images/" + imageDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, imageDTO.getId()))
            .body(imageDTO);
    }
    ...
    public ResponseEntity<ImageDTO> updateImage(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, imageDTO.getId()))
            .body(imageDTO);
    }
    ...
    public ResponseEntity<ImageDTO> partialUpdateImage(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, imageDTO.getId())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ImageDTO>> getAllImages(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
