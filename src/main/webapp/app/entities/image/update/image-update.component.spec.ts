...
describe('Image Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      const image: IImage = { id: 'CBA' };
      const product: IProduct = { id: '376c8be1-0222-4e95-b141-0f38a5ba06c4' };
      image.product = product;

      const productCollection: IProduct[] = [{ id: '1e3dcbde-5472-4a03-ac63-9be66a44e946' }];
    ...
    it('Should update editForm', () => {
      const image: IImage = { id: 'CBA' };
      const product: IProduct = { id: '1fad3d52-8eff-4e10-a213-c271683f62af' };
      image.product = product;
